    ...
    let nav = window.navigator,
        ...
        supportsPDFs =
            ...
            (isModernBrowser ||
                ...
                supportsPdfMimeType ||
                (isIE &&
                    !(!createAXO("AcroPDF.PDF") && !createAXO("PDF.PdfCtrl")))),
        ...
        generatePDFObjectMarkup = function (
            ...
            let el_type =
                    "pdfjs" === embedType || "iframe" === embedType
                        ? "iframe"
                        : "embed",
            ...
            if (
                ...
                let style =
                    "embed" === el_type ? "overflow: auto;" : "border: none;";
        ...
        embed = function (url, targetSelector, options) {
            let selector = targetSelector || !1,
                ...
                assumptionMode =
                    "boolean" != typeof opt.assumptionMode ||
                    opt.assumptionMode,
                forcePDFJS =
                    "boolean" == typeof opt.forcePDFJS && opt.forcePDFJS,
                supportRedirect =
                    "boolean" == typeof opt.supportRedirect &&
                    opt.supportRedirect,
                omitInlineStyles =
                    "boolean" == typeof opt.omitInlineStyles &&
                    opt.omitInlineStyles,
                suppressConsole =
                    "boolean" == typeof opt.suppressConsole &&
                    opt.suppressConsole,
                forceIframe =
                    "boolean" == typeof opt.forceIframe && opt.forceIframe,
